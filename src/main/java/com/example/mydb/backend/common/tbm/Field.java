package com.example.mydb.backend.common.tbm;

import com.example.mydb.backend.common.im.BPlusTree;
import com.example.mydb.backend.common.parser.statement.SingleExpression;
import com.example.mydb.backend.common.tm.TransactionManagerImpl;
import com.example.mydb.backend.common.utils.Panic;
import com.example.mydb.backend.common.utils.ParseStringRes;
import com.example.mydb.backend.common.utils.Parser;
...
/*
Field 类 是字段管理类，负责管理字段的信息和与索引的交互，包括字段的数据持久化、
加载、类型转换、索引操作等。它能够根据字段类型对值进行解析和转换，并与 B+ 树索引交互。
 */
