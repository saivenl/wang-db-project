package com.example.mydb.backend.common.im;

import com.example.mydb.backend.common.SubArray;
...
public class Node {
    ...
    static void setRawIsLeaf(SubArray raw, boolean isLeaf) {
        raw.raw[raw.start + IS_LEAF_OFFSET] = (byte) (isLeaf ? 1 : 0);
    }
    ...
    public static class SearchNextRes {
        long uid;
        long siblingUid;
    }
    ...
    public static class LeafSearchRangeRes {
        List<Long> uids;
        long siblingUid;
    }
    ...
    public static class InsertAndSplitRes {
